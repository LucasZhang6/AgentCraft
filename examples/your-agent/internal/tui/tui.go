...
import (
	...
	"github.com/LucasZhang6/AgentCraft/examples/your-agent/internal/render"
)
...
func (model *Model) View() string {
	if !model.ready {
		return "Initializing Your Agent..."
	}
	title := lipgloss.NewStyle().Bold(true).Foreground(lipgloss.Color("39")).Render("Your Agent")
